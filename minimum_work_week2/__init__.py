...
class Constants(BaseConstants):
    name_in_url = 'minimum_work_week2'
    players_per_group = None
    num_rounds = Params.minimum_work_week2_tasks         # Week 1: set num_rounds = num_minimum_tasks
    num_minimum_tasks = Params.minimum_work_week2_tasks  # minimum number of tasks to complete
